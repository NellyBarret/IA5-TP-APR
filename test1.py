...
class DQNAgent:
    ...
    def __init__(self, params):
        ...
        self.model.add(Dense(24, input_dim=self.state_size, activation='relu'))  # 30, input_shape=(self.state_size,),
    ...
    def experience_replay(self):
        ...
        """
        states, q_val = [], []
        minibatch = self.memory.sample()  # création du batch à partir de la mémoire de l'agent
...
if __name__ == '__main__':
    ...
    memory_size = 2000
    batch_size = 32  # 64
    gamma = 0.95  # 0.99  # importance des récompenses à l'infini
    ...
    for i in range(nb_episodes):
        ...
        state = numpy.reshape(state, [1, state_size])  # TODO: pour avoir un vecteur de 1
        steps = 1
        sum_reward = 0
        while True:
            ...
            next_state = numpy.reshape(next_state, [1, state_size])  # TODO:
