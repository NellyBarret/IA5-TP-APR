...
if __name__ == '__main__':
    ...
    exploration_decay = 0.999  # pour faire descendre l'exploration_rate pour baisser le nombre d'explorations au fur et à mesure que l'agent apprend et devient meilleur
